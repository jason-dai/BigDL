...
### Latest update 🔥 
- [2024/03] `bigdl-llm` now supports both [LangChain](python/llm/example/GPU/LangChain) and [LlamaIndex](python/llm/example/GPU/LlamaIndex) pipelines on [CPU](python/llm/example/CPU/LangChain) and [GPU](python/llm/example/GPU/LangChain).
